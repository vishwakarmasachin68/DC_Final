...
import { Form, Button, Table, Row, Col, Card, Alert, Navbar, Nav, Container } from 'react-bootstrap';
...
const ChallanForm = () => {
  ...
  const removeItem = (index) => {
    ...
    const updatedItems = challan.items.filter((_, i) => i !== index).map((item, i) => ({
      ...item,
      sno: i + 1,
    }));
    setChallan((prev) => ({
      ...
      <Navbar bg="dark" variant="dark" expand="lg" className="mb-4">
        <Container fluid>
          <Navbar.Brand href="#" className="d-flex align-items-center">
            <img src="/deevia-logo.png" alt="Deevia Software" height="40" className="me-2" />
            {/* <span className="app-title">Delivery Challan Generator System</span> */}
          </Navbar.Brand>
        </Container>
      </Navbar>
